<li class="nav-item">
    <a href="<?php echo e(route('game.index')); ?>" class="nav-link">
        ...
        <span class="link-text">Jugar</span>
    </a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="<?php echo e(route('ranking',1)); ?>" class="nav-link">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="crown"
            class="svg-inline--fa fa-crown fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            <path fill="currentColor"
...
<?php /**PATH C:\xampp\htdocs\PrincipiaTFG\resources\views/layouts/userNav.blade.php ENDPATH**/ ?>
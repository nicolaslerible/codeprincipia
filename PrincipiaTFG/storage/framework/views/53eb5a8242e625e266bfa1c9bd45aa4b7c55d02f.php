                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-l-2 col-s-12 col-xs-12 col-form-label">Nombre</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-l-2 col-s-12 col-xs-12 col-form-label">Confirmar Contraseña</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-link">Iniciar sesión</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PrincipiaTFG\resources\views/auth/register.blade.php ENDPATH**/ ?>